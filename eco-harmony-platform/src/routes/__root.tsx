...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sanitation awareness and management connecting urban and rural communities. Report issues, take eco-challenges, and act for a greener tomorrow." },
      { name: "author", content: "EcoSetu" },
      { property: "og:title", content: "EcoSetu — Clean Environment, Healthy Future" },
      { property: "og:description", content: "A nature-first sanitation platform for cities and villages." },
